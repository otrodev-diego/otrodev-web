...
var KTApp = function () {
    ...
    var createDateRangePickers = function() {
        ...
        var start = moment().subtract(29, 'días');
        var end = moment();
        ...
        elements.map(function (element) {
            ...
            var cb = function(start, end) {
                ...
                if (display) {
                    if ( current.isSame(start, "día") && current.isSame(end, "day") ) {
            ...
            $(element).daterangepicker({
                ...
                ranges: {
                'Today': [moment(), moment()],
                'Yesterday': [moment().subtract(1, 'días'), moment().subtract(1, 'días')],
                'Last 7 Days': [moment().subtract(6, 'días'), moment()],
                'Last 30 Days': [moment().subtract(29, 'días'), moment()],
