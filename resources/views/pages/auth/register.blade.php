<x-auth-layout>
    ...
    <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="{{ route('login') }}" action="{{ route('register') }}">
        ...
        <div class="fv-row mb-8">
            <!--begin::Name-->
            <input type="text" placeholder="Nombre" name="name" autocomplete="off" class="form-control bg-transparent"/>
            <!--end::Name-->
        </div>
        ...
        <div class="d-grid mb-10">
            <button type="submit" id="kt_sign_up_submit" class="btn btn-primary">
                @include('partials/general/_button-indicator', ['label' => 'Registrarse'])
            </button>
        </div>
        <!--end::Submit button-->
